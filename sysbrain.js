...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const dashboard_con = document.getElementById('dashboard_content');
    ...
    if (icon_gear) {
        icon_gear.addEventListener('click', () => {
            ...
            // **確保 dashboard_icon 顯示**
            const dashboardIcon = document.getElementById("dashboard_icon");
            if (dashboardIcon) {
                dashboardIcon.style.display = "block"; // 確保它顯示
                dashboardIcon.click(); // 讓它自動變成選中狀態
            }
        });
    }
